    ...
    try {
        ...
        if (actionObject.env) {
            ...
            messageBlocks.push(
                ...
                slackBuilder.buildSimpleSectionMsg('', 'You can change the commands that the app respond to.')
            )
            buttons.push(
                slackBuilder.buildSimpleSlackButton(
                    'Add commands :heavy_plus_sign:',
                    { action: 'settings_app_add' },
                    'settings_app_add'
                ),
                // To-Do: Change for current list of commands
